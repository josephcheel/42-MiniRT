...
void	ft_print_camera(t_field *field)
{
	...
	printf("Viewpoint:\t\t\tX %f, Y %f, Z %f\n", field->camera.center.pos.x, field->camera.center.pos.y, field->camera.center.pos.z);
	printf("Orientation:\t\t\tX %f, Y %f, Z %f\n", field->camera.center.vx.x, field->camera.center.vx.y, field->camera.center.vx.z);
	printf("FOV:\t\t\t\t%d\n", field->camera.fov);
}
